...
<html>
	...
	<body>
		...
		<form id="saveForm" class="form-horizontal" action="${pageContext.servletContext.contextPath}/save.do" method="post">
		  <div class="form-group">
		    <label for="account" class="col-sm-2">账号</label>
		    <div class="col-md-6 col-sm-10">
		      <input type="text" class="form-control" id="account" name="account" placeholder="账号"><span id="accountTip" style="color:red;font-size: 12px"></span>
		    </div>
		  </div>
		  <div class="form-group">
